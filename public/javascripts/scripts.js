...
$(document).ready(function () {
    ...
    var getData = function () {$.get("https://localhost:3000/db/", function(data, textStatus, jqXHR) {
        chart(data);
        chart2(data);
    })};
    ...
    function loadDate (selectedDate) {
        ...
        $.get("https://localhost:3000/db/", function(data, textStatus, jqXHR) {
    ...
    function chart (data) {
        //chartJS : httpsss://www.chartjs.org/docs/#line-chart
